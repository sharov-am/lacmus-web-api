...
namespace lacmus.WebApp.Migrations
{
    ...
    [Migration("20200416182951_Lacmus_Model_Init")]
    partial class Lacmus_Model_Init
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("lacmus.WebApp.Model.DetectedObject", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("ImageAnnotationId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ImageAnnotationId");

                    b.ToTable("DetectedObjects");
                });

            modelBuilder.Entity("lacmus.WebApp.Model.ImageAnnotation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("LacmusImageId")
                        .IsUnique();

                    b.ToTable("ImageAnnotations");
                });

            modelBuilder.Entity("lacmus.WebApp.Model.ImageSource", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("lacmus.WebApp.Model.LacmusProject", b =>
                {
                    ...
                    b.ToTable("LacmusProjects");
                });

            modelBuilder.Entity("lacmus.WebApp.Model.PascalVocBoundingBox", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("DetectedObjectId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("PascalVocBoundingBoxes");
                });
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("lacmus.WebApp.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("lacmus.WebApp.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("lacmus.WebApp.Model.DetectedObject", b =>
                {
                    b.HasOne("lacmus.WebApp.Model.ImageAnnotation", "ImageAnnotation")
                        .WithMany("DetectedObjects")
                        .HasForeignKey("ImageAnnotationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("lacmus.WebApp.Model.ImageAnnotation", b =>
                {
                    b.HasOne("lacmus.WebApp.Model.ImageSource", "Source")
                        .WithMany("LacmusImages")
                        .HasForeignKey("ImageSourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("lacmus.WebApp.Model.LacmusImage", "LacmusImage")
                        .WithOne("ImageAnnotation")
                        .HasForeignKey("lacmus.WebApp.Model.ImageAnnotation", "LacmusImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("lacmus.WebApp.Model.ImageSize", "ImageSize", b1 =>
                        {
                            b1.Property<long>("ImageAnnotationId")
                                .HasColumnType("bigint");
                            ...
                            b1.HasKey("ImageAnnotationId");

                            b1.ToTable("ImageAnnotations");
            ...
            modelBuilder.Entity("lacmus.WebApp.Model.PascalVocBoundingBox", b =>
                {
                    b.HasOne("lacmus.WebApp.Model.DetectedObject", "DetectedObject")
                        .WithOne("BoundingBox")
                        .HasForeignKey("lacmus.WebApp.Model.PascalVocBoundingBox", "DetectedObjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
